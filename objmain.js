...
var ob1 =[
    ...
    { name: 'Q胶液', code: 'Q90', nu: 6, endt: '2023-08-05', pic: '0002.jpg' },
    { name: 'T润滑脂', code: '20T20', nu: 1, endt: '2023-11-20', pic: '0003.jpg' },
    { name: '7密封脂', code: '0075', nu: 20, endt: '2023-07-09', pic: '0004.png' },
    { name: '4密封脂', code: '0074', nu: 20, endt: '2023-09-13', pic: '0005.jpg' },
    { name: '玻璃丝', code: 'bb4', nu: 5, endt: '2023-08-09', pic: '0004.png' },
    { name: '高温带', code: 'gg5', nu: 6, endt: '2023-11-19', pic: '0009.png' },
    { name: '基带', nu: 11, endt: '2024-03-20' },
    { name: '绳子', nu: 20, endt: '2023-09-09' },
    { name: '油膏', nu: 5, endt: '2023-08-09' },
    { name: '基带', nu: 1, endt: '2024-03-20' },
    { name: '绳子', nu: 20, endt: '2023-08-01' },
    { name: '2BDDD', nu: 6, endt: '2023-08-09' },
    { name: '1BDDD', nu: 9, endt: '2023-09-17' },
    { name: '2BDDD', nu: 6, endt: '2023-11-19' }//数量：15
];

var arr = [
    [ob1[0],ob1[1],ob1[2],ob1[3],],//ob1[4],],
    [ob1[5],ob1[6],ob1[7],ob1[8],],//ob1[9],],
